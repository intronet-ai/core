...
exports.toolCallSchema = zod_1.z.object({
    ...
    startedAt: common_1.timestampStubSchema.optional(),
    completedAt: common_1.timestampStubSchema.optional(),
});
// Base message schema with common fields
const baseMessageSchema = zod_1.z.object({
    id: zod_1.z.string().optional(),
    createdAt: common_1.timestampStubSchema.optional(),
    updatedAt: common_1.timestampStubSchema.optional(),
});
// User message schema
