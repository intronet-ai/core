...
const deliverySchema = zod_1.z.object({
    startTime: common_1.timestampStubSchema,
    error: zod_1.z.null(),
    leaseExpireTime: zod_1.z.null(),
    state: zod_1.z.string(),
    endTime: common_1.timestampStubSchema,
...
const mailValueSchema = (dataSchema) => zod_1.z.object({
    ...
    eventsSummary: zod_1.z.record(zod_1.z.string(), common_1.timestampStubSchema).optional(),
});
