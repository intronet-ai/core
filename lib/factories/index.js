...
exports.exampleMailgunWebhook = exports.exampleMail = exports.exampleLinkedinUser = exports.makeFactories = void 0;
...
function makeFactories(TimestampKlass) {
    return {
        announcementFactory: (0, announcement_1.makeAnnouncementFactory)(TimestampKlass),
        announcementRecipientFactory: (0, announcement_1.makeAnnouncementRecipientFactory)(TimestampKlass),
        ...
        profileFactory: (0, user_1.makeUserFactory)(TimestampKlass),
        mailFactory: (0, mail_1.makeMailFactory)(TimestampKlass),
    };
}
exports.makeFactories = makeFactories;
var linkedin_1 = require("./exampleData/linkedin");
Object.defineProperty(exports, "exampleLinkedinUser", { enumerable: true, get: function () { return linkedin_1.exampleLinkedinUser; } });
var mail_2 = require("./exampleData/mail");
Object.defineProperty(exports, "exampleMail", { enumerable: true, get: function () { return mail_2.exampleMail; } });
