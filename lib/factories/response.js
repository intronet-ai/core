...
exports.makeResponseFactory = void 0;
const faker_1 = require("@faker-js/faker");
const Factory = __importStar(require("factory.ts"));
const lodash_1 = require("lodash");
const makeResponseFactory = (TimestampKlass) => Factory.makeFactory({
    createdAt: TimestampKlass.now(),
    updatedAt: TimestampKlass.now(),
    name: faker_1.faker.name.firstName(),
    email: faker_1.faker.internet.email(),
    uid: faker_1.faker.random.alphaNumeric(28),
    communityId: faker_1.faker.random.alphaNumeric(28),
    canOffer: Factory.each(() => (0, lodash_1.sample)(canOfferSamples)),
    helpWanted: Factory.each(() => (0, lodash_1.sample)(helpWantedSamples)),
    workingOn: Factory.each(() => (0, lodash_1.sample)(workingOnSamples)),
});
exports.makeResponseFactory = makeResponseFactory;
