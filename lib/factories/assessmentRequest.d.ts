...
export declare const makeOriginalAssessmentRequestFactory: (TimestampKlass: typeof TimestampStub) => Factory.Sync.Factory<OriginalAssessmentRequest, "createdAt" | "updatedAt" | "seekerResponseId" | "runId" | "providerResponseIds" | "type" | "prompt" | "communityId" | "systemMessage" | "sentAt" | "rawResponse" | "responseReceivedAt" | "approved" | "error" | "actualApiCostCents" | "estimatedApiCostCents">;
